...
?>
	...
	<div class="pg-navigation">
		...
		$pexeto_gal->cat = isset($_GET['cat']) ? $_GET['cat'] : '-1';
		...
		if($pexeto_page['pg_show_filter']=='true'){ ?>
			<div class="pg-cat-filter">
				...
				foreach ($pexeto_gal->cats as $c) {
					...
					<li>
						<a href="<?php echo esc_url (add_query_arg( 'cat', $c->slug, $pexeto_gal->page_url ) ); ?>" <?php echo $pexeto_gal->cclass; ?> data-cat="<?php echo $c->slug; ?>"><?php echo $c->name; ?></a>
					</li><?php
				}
