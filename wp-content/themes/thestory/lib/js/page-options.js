...
(function($){
	...
	$.widget("pexeto.pexetoPageOptions", {
		...
		/**
		 * Hides the parent wrapper box when it doesn't contain any visible items
		 */
		setMetaWrapperVisibility : function(){
			...
			var visibleElemNum = this.$metaOptions.filter(":visible").length;
